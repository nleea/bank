...
class IndexRouter {
    ...
    constructor() {
        ...
        this.#transactionRoute = new transaction_routes_1.TransactionRoute();
    }
    routes() {
        ...
        mergeRouter.use("/client/", [jwt_config_1.jwtAuthenticate.authenticate("jwt", { session: false })], this.#transactionRoute.routes());
